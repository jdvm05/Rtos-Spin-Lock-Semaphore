...
#define INTCTRL         (*((volatile uint32_t *)0xE000ED04)) //IntCtrl (set bit 26 to PENDSTSET call systick
...
void osKernelLaunch(uint32_t quanta)
{
 ...
 {
	SysTick->VAL=0; //reset to zero before trigger
